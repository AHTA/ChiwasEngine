...
namespace ChiwasEngine.Models
{
    public abstract class SettingsBase
    {
        ...
        public virtual void Load(IChiwasEngineContext unitOfWork)
        {
            ...
            foreach (var propertyInfo in _properties)
            {
                ...
                if (setting != null)
                {
                    ...
                    propertyInfo.SetValue(this, Convert.ChangeType(setting.Value, propertyInfo.PropertyType), null);
                }
            }
        }

        public virtual void Save(IChiwasEngineContext unitOfWork)
        {
